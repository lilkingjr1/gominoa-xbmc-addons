...
GITPATH    = os.path.abspath(os.path.dirname(sys.argv[0]))
ZIPPATH    = os.path.join(GITPATH,'repo','')
...
class Generator(object):
    ...
    def create_zip_file( self, fpath, addon):
        ...
        with zipfile.ZipFile(os.path.join(ZIPPATH,addon,addon + '-' + version + '.zip'),
                'w', zipfile.ZIP_DEFLATED) as addonzip:
